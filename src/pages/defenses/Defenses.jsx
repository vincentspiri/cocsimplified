...
export default function Defenses() {
    return (
        <div className="h-screen grid place-items-center grid-flow-row grid-cols-2 gap-5 lg:grid-flow-row lg:grid-cols-6 lg:p-32 md:grid-flow-row md:grid-cols-3 py-28">
            <HomeButton/>
